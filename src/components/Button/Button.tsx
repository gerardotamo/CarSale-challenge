...
const Button = styled('button') <ButtonInterface>`
    background-color: ${props => props.backgroundColor ? props.backgroundColor : BaseColor.blackSecondaryColor};
    cursor: pointer;
    margin: 5px;
    ...
    border-color: ${props => props.borderColor ? props.borderColor : BaseColor.lightBluePrimaryColor};
